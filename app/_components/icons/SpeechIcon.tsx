...
export const SpeechIcon = (props: ComponentPropsWithoutRef<"svg"> & {size?: number}) => {
    const size = props.size ?? 12;
    return (
    <svg      width={size} 
    height={size} 
viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" {...props}>
